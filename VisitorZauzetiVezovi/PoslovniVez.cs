...
{
    public class PoslovniVez : IVrstaVeza
    {
        ...
        public void izracunaj()
        {
            ...
            for (iterator.First(); !iterator.IsDone(); iterator.Next())
            {
                ...
                if (c is MolComposite)
                {
                    ...
                    for (it.First(); !it.IsDone(); it.Next())
                    {
                        ...
                        if (v.Vrsta == "PO" && v.StatusVeza == Enums.StatusVeza.Zauzet)
                        {
                            brZauzetihPoslovnih++;
                        }
                    }
            ...
            brodskaLuka.brojZauzetihPoslovnihVezova = brZauzetihPoslovnih;
        }
    }
}
